...
<body>
	...
	<section id="main">
	<div class="container">
		<h1 id="homeTitle">${totalRowNumber} Computers found</h1>
	...
	<div class="container text-center">
		...
		<div class="btn-group btn-group-sm pull-right" role="group">
			<a type="button" class="btn btn-default"
				href="?pageSize=10&pageNumber=1&search=${search}">10</a> <a
				type="button" class="btn btn-default"
				href="?pageSize=50&pageNumber=1&search=${search}">50</a> <a
				type="button" class="btn btn-default"
				href="?pageSize=100&pageNumber=1&search=${search}">100</a>
		</div>
	</div>
	</footer>
