	...
	<div class="container">
		<div class="row">
			<div class="col-xs-8 col-xs-offset-2 box">
				...
				<h1>
					<spring:message code="local.editComputer" />
				</h1>

				<form:form action="editComputer" method="POST"
					modelAttribute="computerForm">
					<form:input path="id" type="hidden" value="${computer.id}" name="computerId"
						id="id" />
					...
					<div class="actions pull-right">
						<input type="submit" value="<spring:message code="local.edit"/>"
