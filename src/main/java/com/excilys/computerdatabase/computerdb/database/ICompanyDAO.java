...
public interface ICompanyDAO {
    ...
    List<Pageable> getCompanyByName(String name, int limitStart, int size) throws DaoException;

    List<Pageable> getCompanys(int limitStart, int size) throws DaoException;
