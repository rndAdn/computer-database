...
import com.excilys.computerdatabase.computerdb.mapper.ComputerDTOMapper;
...
public class ComputerService {
    ...
    public boolean ajoutComputer(String name, String dateIntroStr, String dateFinStr, String companyId,
            String companyName) {
        if (!ValidatorComputerModel.CONTROLLER_COMPUTER.isValideComputer(name, dateIntroStr, dateFinStr)) {
            return false;
        }

        CompanyDTO.CompanyDTOBuilder companyDTOBuilder = new CompanyDTO.CompanyDTOBuilder();
        CompanyDTO companyDTO;
        if (ValidatorCompanyModel.CONTROLLER_COMPANY.checkId(Utils.stringToId(companyId))) {
