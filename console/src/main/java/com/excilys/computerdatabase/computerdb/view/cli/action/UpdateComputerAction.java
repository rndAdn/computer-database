...
public class UpdateComputerAction implements ActionMenu {
    ...
    public void executeAction() {
        ...
        boolean checkedId = ValidatorComputerModel.CONTROLLER_COMPUTER.checkId(id);
        ...
        boolean checkIntervalDate = ValidatorComputerModel.CONTROLLER_COMPUTER.compareDate(dateIntro, dateFin);
